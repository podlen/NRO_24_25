...
// Preprosta paralelizacija gauss-seidelove metode ni mogoča, saj se v primeru G-S iterativne metode rezultati temperatur znotraj iteracije 
// nanašanjo eden na drugega. Za paralelno reševanje problema je to problematično, saj bi prišlo do problema zapisovanja in branja podatkov iz vektorja 
// temperatur. Najlažja rešitev za problem bi bila rahla modifikacija G-S metode. Morali bi dodati še en vektor temperatur iz katerega bi lahko med 
// iteracijo brali temperature, nove pa zapisovali v nov vektor. No koncu bi zamenjali starega z novim - taka metoda se imenuje Jacobijeva metoda. 

// na iternetu sem našel tudi nekaj načinov, s katerimi bi lahko pralelizirali G-S metodo, eden izmed njih je black-red gauss-seidel metoda.